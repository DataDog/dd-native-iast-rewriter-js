...
mod tests {
    ...
    res1 = (__datadog_test_0 = res1, __datadog_test_1 = s.write(buf.slice(i, _ddiast.plusOperator(i + 1, i, 1))), _ddiast.plusOperator(__datadog_test_0 + __datadog_test_1, __datadog_test_0, __datadog_test_1));\n}");
        Ok(())
    }
