...
mod tests {
    ...
    fn test_plus_inside_array() -> Result<(), String> {
        ...
        (__datadog_test_0 = c, __datadog_test_1 = d, _ddiast.plusOperator(__datadog_test_0 + __datadog_test_1, __datadog_test_0, __datadog_test_1))\n    ]");
        Ok(())
    }
