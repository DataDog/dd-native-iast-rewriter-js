...
const nativeRewriter = process.env.DD_IAST_NATIVE_REWRITER === 'true'
...
function getRewriter () {
  try {
    const iastRewriter = nativeRewriter ? require('node-gyp-build')(__dirname) : require('./wasm/wasm_iast_rewriter')
